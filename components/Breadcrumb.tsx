...
const Breadcrumb = () => {
  ...
  return (
    <nav
      className="text-sm text-gray-600 py-3 px-7 lg:px-0  w-full overflow-x-auto"
    ...
    >
      <ol className="flex flex-nowrap items-center gap-x-2 text-sm whitespace-nowrap">
        <li className="flex items-center min-w-0">
          <Link
            href="/"
            className="inline-block hover:text-red-600 text-sm font-semibold uppercase tracking-wider
             text-gray-900 "
          >
            Home
          </Link>
